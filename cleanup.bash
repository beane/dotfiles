...
FILES="bashrc profile bash_profile vimrc vimrc.bundles gitconfig gitignore_global bash_aliases git-completion.bash inputrc json_pretty_printer_shell/pretty_printer tmux.conf screenrc" # list of files to copy
DIRECTORIES="vagrant"
